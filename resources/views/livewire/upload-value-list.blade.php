@push('pagetitle', 'Upload value list')
@push('breadcrumb')
    @php(
    $breadcrumb_items = [
                ['title' => 'Upload value list for "'.$table_name.'" table', 'url' => route('upload_datafile')],
            ]
    )
...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class=" grid grid-cols-1 md:grid-cols-2  gap-6 lg:gap-8 p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                    ...
                    <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                        This part of the OMEDIS is helping list feeds. The xls, xlsx, or csv file should contain one line per value, one column for each
                        table field, first line with table field name.
                    </p>
                    @if ($default_value)
                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            ...
            <div class="bg-white grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8 p-6 lg:p-8">

                <div>
                    <a href="{{ $return = str_replace('+','/',$incoming_url) }}">
