<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <p class="mb-4 text-sm">This table is listing all datas that can be used in an OMEDIS compliant dataset. There is no required order
        for columns (or data line in xlm file), but each column has to be headed with the corresponding attribute name (ie.NAME). Column having
